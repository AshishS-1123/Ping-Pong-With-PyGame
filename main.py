...
# import pygame package for implementing the game
import pygame
# import random package for generating the ball at random starting points
import random
# import time packag to keep track of time package
...
def update_user_position():
    '''
    Updates the position of User Paddle
...
def update_computer_position():
    '''
    Updates the position of Computer Paddle
...
def get_computer_collision_point():
    '''
    Returns the position at which the ball is expected to collide with the computer paddle.
    This helps make the game single-player by automating the position of computer paddle

    Parameters : None

    Return Value :
        collision_x -> position at which the ball is going to collide with the computer paddle
    '''
...
def check_collision_with_paddle():
    '''
    Checks whether the ball has collided with either of the paddles
    If it has, it sets the new values for ball slope and intercept

    Parameters : None

    Return Value :
        new_slope -> new slope for the line along which the ball should move
        new_c -> new intercept for the line along which the ball should move
        bool -> True of collision has occured, False otherwise
    '''
